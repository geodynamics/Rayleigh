...
output_file = 'Force_Balance_Curls.pdf'
...
def force_components(pind, tind, rind):
    ...
    # Lorentz
    FM_r = -F(1369, pind, tind, rind)
    FM_t = -F(1370, pind, tind, rind)
    FM_p = -F(1371, pind, tind, rind)
    ...
    balance_r = FI_r + FC_r + FM_r + FV_r
    balance_t = FI_t + FC_t + FA_t + FM_t + FV_t + FP_t
    balance_p = FI_p + FC_p + FA_p + FM_p + FV_p + FP_p
