...
my_ref.set_function(dTrefdr,'ds_dr')
my_ref.set_constant(1.0, 'dsdr_scale')
...
chi_ref.set_function(dTrefdr, 'dchirefdr')
chi_ref.set_constant(1.0, 'dchirefdr_scale')
