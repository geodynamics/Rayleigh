...
output_file = 'Force_Balance_Hydro.pdf'
...
def force_components(pind, tind, rind):
    ...
    balance_r = FI_r + FC_r + FP_r + FA_r + FV_r
    balance_t = FI_t + FC_t + FP_t + FV_t
    balance_p = FI_p + FC_p + FP_p + FV_p
